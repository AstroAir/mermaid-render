"""
Configuration and system management MCP tools for diagramaid.
...
def get_configuration(
    ...
    This tool provides access to the current diagramaid configuration,
...
def update_configuration(
    ...
    This tool allows updating diagramaid configuration settings with
...
def get_system_information() -> dict[str, Any]:
    ...
    This tool provides comprehensive information about the diagramaid system,
    ...
    Example:
        ...
        >>> print(result["data"]["version"])  # diagramaid version
    ...
    try:
        ...
        system_info = {
            "diagramaid_version": mermaid_version,
