...
class TestPluginMermaidRenderer:
    ...
    def test_save_to_file(self, mock_stat: Any, mock_open: Any, mock_mkdir: Any, mock_manager_class: Any) -> None:
...
class TestBackwardCompatibility:
    ...
    def test_legacy_mode_still_works(self, mock_pdf: Any, mock_png: Any, mock_svg: Any) -> None:
