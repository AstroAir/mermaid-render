    ...
    def test_diagram_generation_service(self) -> None:
        ...
        class DiagramService:
            ...
            def validate_and_render(
                self, diagram_code: str, format: str = "svg"
            ) -> str:
...
flowchart TD
    ...
    B --> C[Missing bracket
        ...
        {"name": "Empty Diagram", "code": "", "expected_valid": False},
    ]
...
def error_handling_patterns_example(output_dir: Path) -> None:
    ...
    test_scenarios = [
        ...
        {"name": "Empty code", "code": "", "format": "svg"},
    ]
    ...
    for scenario in test_scenarios:
        ...
        error_results.append({"scenario": scenario["name"], "result": result})

        if result["success"]:
            print(
                f"  ✅ Success: Generated {result['format']} ({result['size']} bytes)"
            )
        else:
