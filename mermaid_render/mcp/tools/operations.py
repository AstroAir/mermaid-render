"""
Operation MCP tools for mermaid-render.
...
def export_to_markdown(
    ...
    try:
        ...
        # Elements table
        if include_elements:
            elements = extract_diagram_elements(diagram_code)
        ...
        markdown_parts.append("---\n")
        markdown_parts.append(
            f"*Generated by mermaid-render on {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}*\n"
        )
