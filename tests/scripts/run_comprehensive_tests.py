...
def main() -> bool:
    ...
    test_categories = [
        ...
        },
        {
            ...
            "path": "tests/unit/models/test_diagram_types.py",
            "description": "Comprehensive diagram type tests"
        },
        {
            "name": "Cache System Tests",
            "path": "tests/unit/cache/test_cache.py",
            "description": "Cache system functionality tests"
        },
        {
            "name": "Renderer Tests",
            "path": "tests/unit/renderers/test_renderers.py",
            "description": "SVG, PNG, and PDF renderer tests"
        },
        {
            "name": "Validation Tests",
            "path": "tests/unit/validators/test_validators.py",
            "description": "Diagram validation tests"
        },
        {
            "name": "Error Handling Tests",
            "path": "tests/unit/test_error_handling.py",
        ...
        },
        {
            ...
            "description": "Regression and bug fix tests"
        }
    ]
