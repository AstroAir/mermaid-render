...
with the diagramaid library, including OpenAI, Anthropic, OpenRouter, and
custom providers.
"""
...
class AIProvider(ABC):
    ...
    to be compatible with the diagramaid AI module.
    """
    ...
    def generate_text(self, prompt: str, **kwargs: Any) -> GenerationResponse:
        ...
        try:
            ...
            headers: dict[str, str] = {
                ...
                "HTTP-Referer": cast(
                    str, kwargs.get("site_url", "https://diagramaid.dev")
                ),
