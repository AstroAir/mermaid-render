...
class TestSessionsRouter:
    ...
    def test_create_router(self) -> None:
        ...
        router = create_sessions_router(sessions, websocket_handler)
    ...
    def test_router_has_post_route(self) -> None:
        """Test router has POST endpoint for creating sessions."""
        sessions: dict = {}
        websocket_handler = WebSocketHandler()
        router = create_sessions_router(sessions, websocket_handler)
        post_routes = [
    ...
    def test_router_has_get_route(self) -> None:
        """Test router has GET endpoint for retrieving sessions."""
        sessions: dict = {}
        websocket_handler = WebSocketHandler()
        router = create_sessions_router(sessions, websocket_handler)
        get_routes = [
    ...
    def test_router_has_delete_route(self) -> None:
        """Test router has DELETE endpoint for removing sessions."""
        sessions: dict = {}
        websocket_handler = WebSocketHandler()
        router = create_sessions_router(sessions, websocket_handler)
        delete_routes = [
