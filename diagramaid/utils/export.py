...
def export_to_file(
    ...
    **options: Any,
    ...
    Example:
        >>> from diagramaid import FlowchartDiagram, export_to_file
        >>>
        >>> # Create a diagram
...
def export_multiple_formats(
    ...
    **options: Any,
    ...
    Example:
        >>> from diagramaid import FlowchartDiagram, export_multiple_formats
        >>>
        >>> # Create a diagram
...
def batch_export(
    ...
    **options: Any,
    ...
    Example:
        >>> from diagramaid import FlowchartDiagram, SequenceDiagram, batch_export
        >>>
