"""
Enhanced MermaidRenderer with plugin-based architecture.

This module provides an enhanced version of MermaidRenderer that uses
...
class EnhancedMermaidRenderer:
    ...
    renderer selection, fallback handling, and enhanced error reporting.
    ...
    def __enter__(self) -> "EnhancedMermaidRenderer":
