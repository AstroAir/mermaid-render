"""
MCP prompts package for diagramaid.
...
from .extended import (
    ...
    improve_diagram_quality_prompt,
    refactor_diagram_prompt,
    repair_diagram_prompt,
...
def register_extended_prompts(mcp: Any) -> None:
    ...
    # Repair and Fix prompts
    mcp.prompt(
        name="repair_diagram",
        description="AI-assisted repair of Mermaid diagrams with validation error context",
        tags={"repair", "fix", "validation", "ai"},
    )(repair_diagram_prompt)

    mcp.prompt(
        name="fix_syntax_errors",
        description="Fix syntax errors in a Mermaid diagram",
        tags={"repair", "syntax", "fix"},
    )(fix_syntax_errors_prompt)

    mcp.prompt(
        name="improve_diagram_quality",
        description="Improve diagram quality and apply best practices",
        tags={"quality", "improvement", "best_practices"},
    )(improve_diagram_quality_prompt)
