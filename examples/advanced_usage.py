...
def custom_theme_example(output_dir: Path) -> None:
...
def theme_manager_example(output_dir: Path) -> None:
...
def configuration_example(output_dir: Path) -> None:
...
def batch_processing_example(output_dir: Path) -> None:
    ...
    for format_name, path in multi_paths.items():
...
def complex_diagram_example(output_dir: Path) -> None:
