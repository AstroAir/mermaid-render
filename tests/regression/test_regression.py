...
class TestEdgeCaseHandling:
    ...
    def test_duplicate_node_ids(self):
        ...
        # Adding same ID again should update the existing node
        diagram.add_node("duplicate", "Updated Node")
        
        mermaid_code = diagram.to_mermaid()
        assert "Updated Node" in mermaid_code
        assert "First Node" not in mermaid_code
...
class TestClassDiagramRegressions:
    ...
    def test_class_with_only_attributes(self):
        ...
        diagram = ClassDiagram()
        diagram.add_class("DataOnly", ["data: str", "value: int"], [])
    ...
    def test_class_with_only_methods(self):
        ...
        diagram = ClassDiagram()
        diagram.add_class("BehaviorOnly", [], ["doSomething()", "process()"])
