...
class TestMCPServerCreation:
    ...
    @patch("diagramaid.mcp.server._FASTMCP_AVAILABLE", True)
    def test_create_mcp_server_with_defaults(self):
        """Test server creation with default parameters."""
        from diagramaid.mcp.server import _FASTMCP_AVAILABLE
    ...
    def test_server_module_imports(self):
        ...
        from diagramaid.mcp import server
...
class TestMCPServerConfiguration:
    ...
    def test_default_server_name(self):
        ...
        # Default name should be "diagramaid"
        pass
...
class TestMCPRegistration:
    ...
    def test_register_all_tools_import(self):
        ...
        from diagramaid.mcp import register_all_tools
    ...
    def test_register_extended_tools_import(self):
        ...
        from diagramaid.mcp import register_extended_tools
    ...
    def test_register_all_prompts_import(self):
        ...
        from diagramaid.mcp import register_all_prompts
    ...
    def test_register_extended_prompts_import(self):
        ...
        from diagramaid.mcp import register_extended_prompts
    ...
    def test_register_all_resources_import(self):
        ...
        from diagramaid.mcp import register_all_resources
    ...
    def test_register_extended_resources_import(self):
        ...
        from diagramaid.mcp import register_extended_resources
