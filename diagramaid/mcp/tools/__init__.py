"""
MCP tools package for diagramaid.
...
def register_extended_tools(mcp: Any) -> None:
    ...
    mcp.tool(
        name="repair_diagram",
        description="Automatically repair a Mermaid diagram with comprehensive error fixing and AI assistance",
        tags={"repair", "fix", "validation", "workflow"},
    )(repair_diagram)

    mcp.tool(
        name="validate_and_repair",
        description="Validate a Mermaid diagram and optionally repair it in one step",
        tags={"validation", "repair", "workflow"},
    )(validate_and_repair)

    mcp.tool(
        name="get_repair_suggestions",
        description="Get detailed repair suggestions for a Mermaid diagram without applying fixes",
        tags={"repair", "suggestions", "analysis"},
    )(get_repair_suggestions)

    import logging
    logger = logging.getLogger(__name__)
    logger.info("Registered extended MCP tools including repair workflow")
