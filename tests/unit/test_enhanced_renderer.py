"""
Tests for the EnhancedMermaidRenderer.

This module tests the enhanced renderer that integrates the plugin-based
...
from mermaid_render.enhanced_renderer import EnhancedMermaidRenderer
...
class TestEnhancedMermaidRenderer:
    """Test the EnhancedMermaidRenderer class."""
    
    def test_renderer_creation(self):
        """Test creating an enhanced renderer."""
    ...
    def test_renderer_creation_with_config(self):
    ...
    def test_set_theme_invalid(self):
        ...
        with pytest.raises(ConfigurationError):
            renderer.set_theme(123)  # Invalid type
    
    @patch('mermaid_render.enhanced_renderer.RendererManager')
    def test_render_with_plugin_system(self, mock_manager_class):
    ...
    @patch('mermaid_render.enhanced_renderer.RendererManager')
    def test_render_failure(self, mock_manager_class):
    ...
    @patch('mermaid_render.enhanced_renderer.RendererManager')
    def test_render_with_diagram_object(self, mock_manager_class):
    ...
    def test_save_to_file(self, mock_stat, mock_open, mock_mkdir, mock_manager_class):
    ...
    @patch('mermaid_render.enhanced_renderer.RendererManager')
    def test_get_available_renderers(self, mock_manager_class):
    ...
    @patch('mermaid_render.enhanced_renderer.RendererManager')
    def test_test_renderer(self, mock_manager_class):
    ...
    @patch('mermaid_render.enhanced_renderer.RendererManager')
    def test_benchmark_renderers(self, mock_manager_class):
    ...
    def test_context_manager(self):
        ...
        with EnhancedMermaidRenderer() as renderer:
            assert isinstance(renderer, EnhancedMermaidRenderer)
...
class TestBackwardCompatibility:
    ...
    def test_legacy_mode_still_works(self, mock_pdf, mock_png, mock_svg):
    ...
    def test_plugin_mode_integration(self):
